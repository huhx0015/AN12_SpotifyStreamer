...
public class SSApplication extends Application implements OnMusicServiceListener {
    ...
    // BITMAP VARIABLES
    public Bitmap currentBitmap; // Used to reference the current bitmap artist or album image.
    ...
    // onCreate(): The initial function that is called when the application is started.
    @Override
